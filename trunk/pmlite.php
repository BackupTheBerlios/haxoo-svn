 ...
 * @package         core
 * @since           2.0.0
 * @version         $Id: pmlite.php 5328 2010-09-18 23:52:50Z kris_fr $
 */
...
if (is_object($xoopsUser)) {
    ...
    if (isset($_POST['op']) && $_POST['op'] == "submit") {
        ...
        echo "<table style='width:300px; text-align:center;' class='outer'><tr><td class='head' style='width:25%'>" . _PM_TO . "</td>";
        if ($reply == 1) {
        ...
        echo "</tr>";
        echo "<tr><td class='head' style='width:25%;'>" . _PM_SUBJECTC . "</td>";
        if ($reply == 1) {
        ...
        echo "</tr>";
        echo "<tr style='vertical-align:top;'><td style='width:25%;' class='head'>" . _PM_MESSAGEC . "</td>";
        echo "<td class='even'>";
