...
function make_data(&$dbm, &$cm, $adminname, $adminpass, $adminmail, $language, $gruops){
    ...
    $time = time();
    $dbm->insert('tplset', " VALUES (1, 'default', 'HAXOO Default Template Set', '', ".$time.")");
    ...
    $dbm->insert('config', " VALUES (1, 0, 1, 'sitename', '_MD_AM_SITENAME', 'HAXOO Site', '_MD_AM_SITENAMEDSC', 'textbox', 'text', 0)");
	...
	$dbm->insert('config', " VALUES (39, 0, 3, 'footer', '_MD_AM_FOOTER', 'Powered by HAXOO preview &copy; 2010-2010-" . date('Y', time()) . " <a href=\"http://haxoo.berlios.de/\" target=\"_blank\">The HAXOO Project</a>', '_MD_AM_FOOTERDSC', 'textarea', 'text', 20)");
    ...
    $dbm->insert('config', " VALUES (50, 0, 3, 'meta_copyright', '_MD_AM_METACOPYR', 'Copyright &copy; 2010-" . date('Y', time()) . "', '_MD_AM_METACOPYRDSC', 'textbox', 'text', 8)");
