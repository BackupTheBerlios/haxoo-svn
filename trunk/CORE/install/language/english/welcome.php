...
"<u><b>What is it?</b></u>
<p>
<b>HAXOO</b> is a dynamic OO (Object Oriented) based open source portal script written in PHP.
HAXOO supports a number of databases,
making HAXOO an ideal tool for developing small to large dynamic community websites,
intra company portals, corporate portals, weblogs and much more.
</p>
<p>
HAXOO is based on XOOPS - which has been modded, hacked, changed etc., hence the name HA(cked) XOO(ps) = HAXOO.
</p>
<p>
HAXOO is released under the terms of the <a href='http://www.gnu.org/copyleft/gpl.html' target='_blank'>GNU General Public License (GPL)</a> and is free to use and modify.
...
<li>Prepare a database for your HAXOO site.</li>
