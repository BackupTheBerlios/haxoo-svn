<?php
// $Id: install.php 1240 2008-01-10 04:06:08Z julionc $
define("_INSTALL_L0","Welcome to the Install Wizard for HAXOO");
...
define("_INSTALL_L6","There is a mismatch between your HAXOO_ROOT_PATH configuration on line 31 of mainfile.php and the root path info we have detected.");
...
define("_INSTALL_L11","The server path to your HAXOO root directory: ");
define("_INSTALL_L12","URL to your HAXOO root directory: ");
...
define("_INSTALL_L19","%s is the name of your database in which HAXOO tables will be created.");
...
define("_INSTALL_L63","This prefix will be added to all new tables created to avoid name conflict in the database. If you are unsure, just use the default 'haxoo'.");
define("_INSTALL_L54","Use persistent connection?");
define("_INSTALL_L69","Default is 'NO'. Choose 'NO' if you are unsure.");
define("_INSTALL_L55","HAXOO Physical Path");
define("_INSTALL_L59","Physical path to your main HAXOO directory WITHOUT trailing slash");
define("_INSTALL_L56","HAXOO Virtual Path (URL)");
define("_INSTALL_L58","Virtual path to your main HAXOO directory WITHOUT trailing slash");
...
define("_INSTALL_L35","If you had any errors, please contact the dev team at <a href='http://haxoo.berlios.de/' target='_blank'>the HAXOO Project</a>");
...
define("_INSTALL_L95","Could not detect the physical path to your HAXOO directory.");
...
define("_INSTALL_L130","The installer has detected tables for XOOPS 1.3.x in your database.<br />The installer will now attempt to upgrade your database to HAXOO.");
define("_INSTALL_L131","Tables for HAXOO already exist in your database.");
...
define("_INSTALL_L141","The installer will now update each module to work with HAXOO.<br />Make sure that you have uploaded all files in HAXOO package to your server.<br />This may take a while to complete.");
define("_INSTALL_L142","Updating modules..");
define("_INSTALL_L143","The installer will now update configuration data of XOOPS 1.3.x to be used with HAXOO.");
...
define("_INSTALL_L149","The installer will now update comment posts in XOOPS 1.3.x to be used in HAXOO.<br />This may take a while to complete.");
define("_INSTALL_L150","The installer will now update the smiley and user rank images to be used with HAXOO.<br />This may take a while to complete.");
define("_INSTALL_L151","The installer will now update the user avatar images to be used in HAXOO.<br />This may take a while to complete.");
