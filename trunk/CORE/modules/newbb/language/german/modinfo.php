...
define("_MI_NEWBB_INSTALL_POST_TEXT", "
	Willkommen zu diesem neuen Forum.<br />
	Jetzt Registrieren, Anmelden und mit Themen starten.<br /><br />
	Für Fragen hinsichtlich des CBB steht die lokale Supportseite oder die <a href=\"http://www.myxoops.org/modules/newbb/\" target=\"_blank\" title=\"CBB @ myXOOPS\">CBB Modul Seite</a> zur Verfügung.
	");
	

define("_MI_NEWBB_ADMENU_GROUPMOD", "Gruppenmoderation");
