...
$pdf_config['creator'] = 'NEWBB BASED ON FPDF v1.53';
...
$pdf_config['footerpage'] = 'footerpage???';

// For local support sites
define('NEWBB_PDF_FORUM', 'Forum');
define('NEWBB_PDF_TOPIC', 'Thema');
define('NEWBB_PDF_SUBJECT', 'Betreff');
define('NEWBB_PDF_AUTHOR', _POSTEDBY);
define('NEWBB_PDF_DATE', 'Datum');
define('NEWBB_PDF_URL',_MD_COMEFROM);
...
class PDF_language extends FPDF
{
	...
	function _encoding($text, $in_charset, $out_charset)
	{
        ...
        // return XoopsLocal::convert_encoding($text);
	}
}
?>