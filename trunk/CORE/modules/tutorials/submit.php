...
function addTutorial(){
	global $xoopsDB, $xoopsConfig, $xoopsUser, $xoopsLogger, $xoopsMF, $HTTP_GET_VARS, $HTTP_POST_VARS, $myts, $xoopsTheme, $useruploads, $imgwidth, $imgheight;
	include(XOOPS_ROOT_PATH."/header.php");
	if ($useruploads == 1) {
...
function PreviewTutorial() {
	global $xoopsDB,$xoopsConfig, $xoopsTheme, $HTTP_POST_VARS, $myts, $mytree, $content_visdefault, $content_default, $content_visualize, $imgwidth, $imgheight, $useruploads, $xoopsUser, $xoopsLogger, $xoopsMF;
	include(XOOPS_ROOT_PATH."/header.php");
...
function SaveTutorial() {
    global $xoopsDB,$xoopsConfig, $HTTP_POST_VARS, $myts, $eh, $xoopsUser, $xoopsLogger, $xoopsMF;
...
function editTutorial() {
	global $xoopsDB,$xoopsConfig, $HTTP_GET_VARS, $myts, $eh, $mytree, $useruploads, $imgwidth, $imgheight, $xoopsUser, $xoopsLogger, $xoopsMF;
	include(XOOPS_ROOT_PATH."/header.php");
