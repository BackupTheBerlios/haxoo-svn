...
$errortxt = "";
# create dir field ########################
$result = @mysql_query("select dir from ".$xoopsDB->prefix("tutorials")."");
if (!$result) {
...
$result = @mysql_query("select logowidth from ".$xoopsDB->prefix("tutorials")."");
if (!$result) {
...
$result = @mysql_query("select logoheight from ".$xoopsDB->prefix("tutorials")."");
if (!$result) {
...
$result = @mysql_query("select timgwidth from ".$xoopsDB->prefix("tutorials")."");
if (!$result) {
...
$result = @mysql_query("select timgheight from ".$xoopsDB->prefix("tutorials")."");
if (!$result) {
...
$result = @mysql_query("select cimgwidth from ".$xoopsDB->prefix("tutorials_categorys")."");
if (!$result) {
...
$result = @mysql_query("select cimgheight from ".$xoopsDB->prefix("tutorials_categorys")."");
if (!$result) {
