...
// -----------------------------------------------------------------------------------------------------------//
function modCat() {
	global $xoopsDB, $HTTP_POST_VARS, $myts, $mytree, $imgwidth, $imgheight;
	xoops_cp_header();
	...
	list($scid,$cname,$cdesc,$cimg,$cimgwidth,$cimgheight) = $xoopsDB->fetchRow($result);
    ...
    if ($numrows>0) {
    	...
    	while(list($cid) = $xoopsDB->fetchRow($result2)) {
			if($cid != $cidmerk) {
				...
				list($cid, $cname) = $xoopsDB->fetchRow($result3);
...
// -----------------------------------------------------------------------------------------------------------//
function modGroup() {
	global $xoopsDB, $HTTP_POST_VARS, $myts, $mytree;
	xoops_cp_header();
	...
	list($cid,$pos,$gname) = $xoopsDB->fetchRow($result);
	...
	list($scid,$cname) = $xoopsDB->fetchRow($result2);
	$cname = $myts->makeTboxData4Edit($cname);
...
function addTutorial(){
	global $xoopsDB, $xoopsUser, $HTTP_GET_VARS, $myts, $imgwidth, $imgheight;
	xoops_cp_header();
	...
	list($scid,$cname,$cdesc,$cimg) = $xoopsDB->fetchRow($result);
	$cname=$myts->makeTboxData4Show($cname);
...
function PreviewTutorial() {
	global $xoopsDB,$xoopsConfig, $HTTP_POST_VARS, $myts, $mytree, $content_visdefault, $content_default, $content_visualize, $imgwidth, $imgheight;
	xoops_cp_header();
...
function SaveTutorial() {
    global $xoopsDB, $xoopsConfig, $xoopsUser, $HTTP_POST_VARS, $myts, $eh;
...
// Check if Content exist
	...
	if($tid == 0) {
        ...
        list($statusdb, $date) = $xoopsDB->fetchRow($result);
        if ($statusdb != 2) {
			$time = time();
		}
		$date = $time;
...
function modTutorial() {
	global $xoopsDB,$xoopsConfig, $HTTP_POST_VARS, $myts;
...
function editTutorial() {
	global $xoopsDB,$xoopsConfig, $HTTP_POST_VARS, $HTTP_GET_VARS, $myts, $eh, $mytree, $imgwidth, $imgheight;
	xoops_cp_header();
	...
	list($tid,$cid,$gid,$tname,$tdesc,$timg,$tcont,$tlink,$tauthor,$status,$codes,$hits,$rating,$votes,$time,$submitter,$dir,$timgwidth,$timgheight) = $xoopsDB->fetchRow($result);
...
function waitTutorial() {
	global $xoopsDB,$xoopsConfig, $HTTP_GET_VARS, $myts, $eh, $mytree, $content_visdefault, $content_default, $content_visualize;
	xoops_cp_header();
	...
	list($tid,$cid,$gid,$tname,$tdesc,$timg,$tcont,$tlink,$tauthor,$status,$hits,$rating,$votes,$codes,$time,$submitter,$dir,$timgwidth,$timgheight) = $xoopsDB->fetchRow($result);
...
function delTutorial() {
	global $xoopsDB,$xoopsConfig, $HTTP_POST_VARS, $HTTP_GET_VARS, $myts, $eh;
