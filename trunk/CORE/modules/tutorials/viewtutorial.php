...
// -----------------------------------------------------------------------------------------------------------//
    ...
    list($tid, $cid, $tname, $timg, $tcont, $tauthor, $codes, $hits, $rating, $votes, $date, $submitter, $timgwidth, $timgheight) = $xoopsDB->fetchRow($result);
    ...
    list($cid, $cname) = $xoopsDB->fetchRow($result2);
