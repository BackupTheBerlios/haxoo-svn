<?php
// $Id: xoops_version.php,v 1.22 2009/01/20 10:22:10 yoshis Exp $
//  ------------------------------------------------------------------------ //
...
$modversion['credits'] = "Tweak by Bluemoon inc. ( http://www.bluemooninc.biz/ ) /  Based original mydownloads v1.10 by Kazumi Ono ( http://www.myweb.ne.jp/ )";
...
// Templates
$modversion['templates'][]=array('file'=>'mydownloads_brokenfile.html','description'=>'');
$modversion['templates'][]=array('file'=>'mydownloads_download.html'  ,'description'=>'');
$modversion['templates'][]=array('file'=>'mydownloads_index.html'     ,'description'=>'');
$modversion['templates'][]=array('file'=>'mydownloads_modfile.html'   ,'description'=>'');
$modversion['templates'][]=array('file'=>'mydownloads_ratefile.html'  ,'description'=>'');
$modversion['templates'][]=array('file'=>'mydownloads_singlefile.html','description'=>'');
$modversion['templates'][]=array('file'=>'mydownloads_submit.html'    ,'description'=>'');
$modversion['templates'][]=array('file'=>'mydownloads_topten.html'    ,'description'=>'');
$modversion['templates'][]=array('file'=>'mydownloads_viewcat.html'   ,'description'=>'');
$modversion['templates'][]=array('file'=>'mydownloads_filelist.html'  ,'description'=>'');
...
*/
$modversion['config'][10]['name'] = 'maxuploadsize';
$modversion['config'][10]['title'] = '_MI_MYDOWNLOADS_UPLOADFILESIZE';
$modversion['config'][10]['description'] = '_MI_MYDOWNLOADS_UPLOADFILESIZE_DESC';
$modversion['config'][10]['formtype'] = 'textbox';
$modversion['config'][10]['valuetype'] = 'int';
$modversion['config'][10]['default'] = 1048576;

$modversion['config'][11]['name'] = 'uploadtypes';
$modversion['config'][11]['title'] = '_MI_MYDOWNLOADS_UPLOADFILETYPE';
$modversion['config'][11]['description'] = '_MI_MYDOWNLOADS_UPLOADFILETYPE_DESC';
$modversion['config'][11]['formtype'] = 'textbox';
$modversion['config'][11]['valuetype'] = 'text';
$modversion['config'][11]['default'] = 'zip|tar|lzh|pdf|msword|excel|powerpoint';

$modversion['config'][] = array(
	'name'        => 'filename_code',
	'title'       => '_MI_MYDOWNLOADS_FILECHRSET',
	'description' => '_MI_MYDOWNLOADS_FILECHRSET_DESC',
	'formtype'    => 'textbox',
	'valuetype'   => 'text',
	'default'     => 'SJIS'
);
$modversion['config'][] = array(
	'name'			=> 'uploadgroups' ,
	'title'			=> '_MI_MYDOWNLOADS_UPLOADGROUPS' ,
	'description'	=> '_MI_MYDOWNLOADS_UPLOADGROUPS_DESC' ,
...
$modversion['config'][] = array(
	'name'        => 'show_option',
	'title'       => '_MI_MYDOWNLOADS_SHOWOPTION',
	'description' => '_MI_MYDOWNLOADS_SHOWOPTIONDSC',
	'formtype'    => 'yesno',
	'valuetype'   => 'int',
	'default'     => 1
);
