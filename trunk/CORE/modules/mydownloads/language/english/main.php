...
define("_MD_NEWARRIVAL","New Arrival with Category");
define("_MD_FILELIST","File list");
...
define("_MD_DELETEFILE","Are you sure you want to delete the file \"%s\"" );
define("_MD_FILENAME","File name");
define("_MD_TYPE","File type");
define("_MD_SIZE","Size");
define("_MD_CTRL","Control");
