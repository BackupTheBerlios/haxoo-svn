<?php
// $Id: modinfo.php,v 1.1 2008/01/22 10:35:10 yoshis Exp $
// Module Info
...
define("_MI_MYDOWNLOADS_SMNAME4","File List");
...
// After v1.05
define('_MI_MYDOWNLOADS_SHOWOPTION','Show the options');
define('_MI_MYDOWNLOADS_SHOWOPTIONDSC','Show vote,comment and etc options?');
// After v1.20
define("_MI_MYDOWNLOADS_UPLOADGROUPS","Authorized groups to upload");
define("_MI_MYDOWNLOADS_UPLOADGROUPS_DESC","Select the groups who can upload to the server");
define('_MI_MYDOWNLOADS_UPLOADFILESIZE','MAX Filesize Upload (KB) 1048576 = 1 Meg');
define("_MI_MYDOWNLOADS_UPLOADFILESIZE_DESC","");
define('_MI_MYDOWNLOADS_UPLOADFILETYPE','File type for upload (MIMIE strings devide |)');
define("_MI_MYDOWNLOADS_UPLOADFILETYPE_DESC","");
define('_MI_MYDOWNLOADS_FILECHRSET', 'Charactor cord as file system of server(SJIS,UTF-8,EUC-JP)');
define('_MI_MYDOWNLOADS_FILECHRSET_DESC', '');
