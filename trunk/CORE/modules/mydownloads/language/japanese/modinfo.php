...
define("_MI_MYDOWNLOADS_SMNAME4","ファイル一覧");
...
// After v1.05
define('_MI_MYDOWNLOADS_SHOWOPTION','オプション項目を表示する');
define('_MI_MYDOWNLOADS_SHOWOPTIONDSC','評価・コメント等のオプションを使用する場合は「はい」を選択してください。');
define("_MI_MYDOWNLOADS_UPLOADGROUPS","アップロードを許可されたグループ");
define("_MI_MYDOWNLOADS_UPLOADGROUPS_DESC","サーバーにアップロード可能なグループを選択");
define('_MI_MYDOWNLOADS_UPLOADFILESIZE','最大アップロードファイルサイズ(byte)1048576=1MB');
define("_MI_MYDOWNLOADS_UPLOADFILESIZE_DESC","");
define('_MI_MYDOWNLOADS_UPLOADFILETYPE','アップロードファイルの種類(MIMIE文字列を | 区切りにて併記)');
define("_MI_MYDOWNLOADS_UPLOADFILETYPE_DESC","");
define('_MI_MYDOWNLOADS_FILECHRSET', '保存時のファイル名称コード(SJIS,UTF-8,EUC-JP)');
