<?php
// $Id: main.php 4181 2010-01-19 18:51:22Z kris_fr $
...
define("_PL_VOTERS", "Total des votants");
define("_PL_VOTES", "Total des votes");
define("_PL_EXPIRATION", "Expiration");
define("_PL_EXPIRED", "Expiré");
define("_PL_MUSTLOGIN", "Désolé, mais vous devez vous connecter pour pouvoir voter à ce sondage.");
//%%%%%%        File Name xoopspollrenderer.php         %%%%%
// %s represents date
define("_PL_ENDSAT","Fini le %s");
define("_PL_ENDEDAT","Fini le %s");
