...
/**
* $Id: blocks.php,v 1.3 2004/12/19 17:15:03 malanciault Exp $
* Module: SmartAssociate
* Author: The SmartFactory <www.smartfactory.ca>
* Licence: GNU
*/

define('_MB_SPARTNER_PARTNERS_PSPACE', 'Put spaces between associates?');
define('_MB_SPARTNER_BRAND', 'Randomize associates in blocks?');
...
define('_MB_SPARTNER_SEE_ALL', "Display 'See all associates...'");
define('_MB_SPARTNER_LANG_SEE_ALL', "See all associates...");
