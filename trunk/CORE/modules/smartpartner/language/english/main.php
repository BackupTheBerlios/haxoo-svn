...
define("_MD_SPARTNER_NOPARTNERSELECTED", "You did not select a valid associates.");
define("_MD_SPARTNER_NOTIFY", "Notify on approval");
define("_MD_SPARTNER_READMORE", "Read more...");
define("_MD_SPARTNER_SUBMIT_ERROR", "An error occured while submitting the associates.");
define("_MD_SPARTNER_SUBMIT_SUCCESS", "The associates was successfully submitted.");

define("_MD_SPARTNER_EDIT", "Edit");
define("_MD_SPARTNER_DELETE", "Delete");
define("_MD_SPARTNER_JOIN", "Become a Associate");
define("_MD_SPARTNER_PARTNERS", "Associates");
define("_MD_SPARTNER_PARTNERSTITLE", "The associates of ");
define("_MD_SPARTNER_PARTNER", "Associate");
define("_MD_SPARTNER_DESCRIPTION", "Description");
define("_MD_SPARTNER_HITS", "Hits");
define("_MD_SPARTNER_NOPART", "There is currently no associates to display.");
//file join.php
...
define("_MD_SPARTNER_NEWPARTNER", "%s Associates Request");
...
define("_MD_SPARTNER_INTRO_TEXT", "Here is the list of our prefered associates. You can access their web site by clicking on their logo");
define("_MD_SPARTNER_INTRO_JOIN", "You would like to become a associates of %s? Fill out the following form and we will contact you as soon as possible.");
...
define("_MD_SPARTNER_BACKTOINDEX", "Back to associates index");
