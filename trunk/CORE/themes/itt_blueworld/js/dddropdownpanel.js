...
var defaultpanel=new ddpanel({
	...
	stateconfig: {initial: "0px", persiststate: true}, // initial: initial reveal amount in pixels (ie: 0px)
	animate: {enabled: true, steps: 5}, //steps: number of animation steps. Int between 1-20. Smaller=faster.
	pointerimage: {enabled: true, src: ["/themes/itt_blueworld/images/arrow-down.gif", "/themes/itt_blueworld/images/arrow-up.gif"]},
