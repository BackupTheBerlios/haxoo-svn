<?php
// $Id: system_blocks.php 5444 2010-10-07 08:07:28Z voltan1 $
//  ------------------------------------------------------------------------ //
...
function b_system_waiting_show()
{
    ...
    if ($module_handler->getCount(new Criteria('dirname', 'TDMDownloads'))) {
    ...
    if ($module_handler->getCount(new Criteria('dirname', 'extgallery'))) {
   ...
   // waiting content for smartsection
    if ($module_handler->getCount(new Criteria('dirname', 'smartsection'))) {
