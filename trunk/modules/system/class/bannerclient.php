...
class SystemBannerclient extends XoopsObject
{
    ...
    function getForm($action = false)
    {
        ...
        $form->addElement(new XoopsFormText( _AM_SYSTEM_BANNERS_CONTNAMET, 'contact', 50, 255, $this->getVar('contact') ), true );
        $form->addElement(new XoopsFormText( _AM_SYSTEM_BANNERS_CONTMAILT, 'email', 50, 255, $this->getVar('email') ), true );
        $form->addElement(new XoopsFormText( _AM_SYSTEM_BANNERS_CLILOGINT, 'login', 50, 255, $this->getVar('login') ), true );
        $form->addElement(new XoopsFormText( _AM_SYSTEM_BANNERS_CLIPASST, 'passwd', 50, 255, $this->getVar('passwd') ), true );
