<?php
// $Id: xoopspoll.php,v 1.18 2005/06/26 15:38:29 mithyt2 Exp $
//  ------------------------------------------------------------------------ //
...
// create table headers
	...
	<tr><td><table class='outer' width='100%' border='0' cellpadding='4' cellspacing='1' >
		...
		for ( $i = 0; $i < $max; $i++ ) {
            ...
            ."'><img src=". $pathImageIcon .'/edit.png'.' '. "alt='"._AM_EDITPOLL."' title='"._AM_EDITPOLL."'></a>          
            ...
            ."'><img src=". $pathImageIcon .'/search.png'.' '." alt='"._AM_VIEWLOG."' title='"._AM_VIEWLOG."'></a></td>
		</tr>";
...
//	echo "<h4>"._AM_POLLCONF."</h4>";
	...
	$arrow_up = $pathImageIcon .'/up.gif';
	$arrow_down =  $pathImageIcon .'/down.gif';
